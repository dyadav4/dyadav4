...
- 25,794+ medical cell images from 118 patients
- CNN-based classification with transfer learning

### 📱 [SnapHabit](https://github.com/dyadav4/SnapHabit)
**Modern iOS habit tracking app** *(Active Development)*
- Built with SwiftUI and native iOS frameworks
- CloudKit integration for data sync
- APNs push notifications with smart scheduling
- Clean architecture with MVVM pattern

### 🚗 [Autonomous Vehicle Detection](https://github.com/dyadav4/Autonomous-driving-application-car-detection)
**YOLO-based real-time object detection for self-driving cars**
- YOLO v2 implementation for vehicle detection
- Real-time inference on dashcam footage
- Bounding box prediction and visualization

### 📊 [Bitcoin Analysis](https://github.com/dyadav4/investigating-bitcoin)
**Comprehensive cryptocurrency market analysis**
- Time series forecasting with ARIMA
- Market trend visualization and clustering
- Statistical analysis of price movements

## 💼 All Projects

### 📱 iOS Development
- **[SnapHabit](https://github.com/dyadav4/SnapHabit)** - Habit tracker with CloudKit & APNs
- **[DallasWay](https://github.com/dyadav4/DallasWay)** - Location-based attractions finder with MapKit
...
- **[Movie Sentiment Analysis](https://github.com/dyadav4/movie-sentiment-analysis)** - NLP sentiment classification
- **[Baby Safety Monitor](https://github.com/dyadav4/HackerEarth-Deep-Learning-challenge-Keep-babies-safe)** - Deep learning for safety monitoring

### 📊 Data Science
- **[Bitcoin Investigation](https://github.com/dyadav4/investigating-bitcoin)** - Crypto market analysis in R
- **[Caterpillar Anomaly Detection](https://github.com/dyadav4/2020-HackIllinois-Caterpillar-Anomaly-Detection)** - HackIllinois 2020 winning solution
